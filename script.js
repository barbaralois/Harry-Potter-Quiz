...
function quizResults() {
  ...
  if (currentScore > 7) {
    $("section.main-content").replaceWith(`<section class="main-content"><img src="https://i.imgur.com/MMw5M7U.png" alt="Outstanding written in Harry Potter style font" class="images image-results"><h1>Your Score: ${currentScore}/10</h1><p>You’re no casual Harry Potter fan...you know your stuff, and you did a great job on this quiz. Congratulations on achieving the highest rating!</p><a href="https://barbaralois.github.io/Harry-Potter-Quiz/welcome.html" class="submit-button" role="button">Play Again</a></section>`)
  }
  else if (currentScore > 3) {
    $("section.main-content").replaceWith(`<section class="main-content"><img src="https://i.imgur.com/Yt9ijDU.png" alt="Acceptable written in Harry Potter style font" class="images image-results"><h1>Your Score: ${currentScore}/10</h1><p>Your Harry Potter knowledge could use a little brushing up...maybe it's time to reread the series and see if you can improve your score!</p><a href="https://barbaralois.github.io/Harry-Potter-Quiz/welcome.html" class="submit-button" role="button">Play Again</a></section>`)
  }
  else {
    $("section.main-content").replaceWith(`<section class="main-content"><img src="https://i.imgur.com/tphGq8w.png" alt="Dreadful written in Harry Potter style font" class="images image-results"><h1>Your Score: ${currentScore}/10</h1><p>Oh, dear. Have you read the Harry Potter books? If not, you are missing out on a wonderful fantasy universe! You should pick up a copy of Harry Potter and the Sorcerer's Stone and see what the buzz is about.</p><a href="https://barbaralois.github.io/Harry-Potter-Quiz/welcome.html" class="submit-button" role="button">Play Again</a></section>`)
  };
};
